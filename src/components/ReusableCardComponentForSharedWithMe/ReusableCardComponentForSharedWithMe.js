...
import styles from './ReusableCardComponentForSharedWithMe.module.css';
import { Card } from 'react-bootstrap';
import moment from 'moment';
import RatingStars from '../RatingStars/RatingStars';

const ReusableCardComponentForSharedWithMe = (props) => (
  <Card className={styles.answeredQuestionsCard}>
    ...
    <div className={styles.actionButtonDiv}>
      {props.data.favourite === true ? <i class="fa-solid fa-heart" style={{ "color": "#FF6A00" }}></i> : <i class="fa-solid fa-heart" style={{ "color": "#D3D3D3" }}></i>}
    </div>
    <Card.Body className={styles.spacer}>
      <Card.Title>
        {props.data.additionalContext &&
...
ReusableCardComponentForSharedWithMe.propTypes = {};

ReusableCardComponentForSharedWithMe.defaultProps = {};

export default ReusableCardComponentForSharedWithMe;
